...
//AmmoPool duplicate that supports negative reload counts
//Only changes made are to checks in EnergyPool.GiveAmmo and ReloadEnergyPool.Reload

namespace OpenRA.Mods.RA2.Traits
{
	[Desc("Actor has a limited amount of ammo, after using it all the actor must reload in some way.")]
	public class EnergyPoolInfo : TraitInfo
	{
		...
		public override object Create(ActorInitializer init) { return new EnergyPool(init.Self, this); }
	}

	public class EnergyPool : INotifyCreated, INotifyAttack, ISync
	{
		public readonly EnergyPoolInfo Info;
		...
		public EnergyPool(Actor self, EnergyPoolInfo info)
		{
			Info = info;
