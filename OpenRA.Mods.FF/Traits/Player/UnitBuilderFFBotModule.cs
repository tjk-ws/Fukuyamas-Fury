...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class UnitBuilderFFBotModuleInfo : ConditionalTraitInfo
	{
		...
		public override object Create(ActorInitializer init) { return new UnitBuilderFFBotModule(init.Self, this); }
	}

	public class UnitBuilderFFBotModule : ConditionalTrait<UnitBuilderFFBotModuleInfo>, IBotTick, IBotNotifyIdleBaseUnits, IBotRequestUnitProduction, IGameSaveTraitData
	{
		...
		public UnitBuilderFFBotModule(Actor self, UnitBuilderFFBotModuleInfo info)
			: base(info)
		{
			world = self.World;
			player = self.Owner;
