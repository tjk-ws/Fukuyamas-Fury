...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class BaseBuilderFFBotModuleInfo : ConditionalTraitInfo
	{
		...
		public override object Create(ActorInitializer init) { return new BaseBuilderFFBotModule(init.Self, this); }
	}

	public class BaseBuilderFFBotModule : ConditionalTrait<BaseBuilderFFBotModuleInfo>, IGameSaveTraitData,
		IBotTick, IBotPositionsUpdated, IBotRespondToAttack, IBotRequestPauseUnitProduction
	{
		...
		List<BaseBuilderFFQueueManager> builders = new List<BaseBuilderFFQueueManager>();

		public BaseBuilderFFBotModule(Actor self, BaseBuilderFFBotModuleInfo info)
			: base(info)
		{
			world = self.World;
			player = self.Owner;
		...
		protected override void TraitEnabled(Actor self)
		{
			foreach (var building in Info.BuildingQueues)
				builders.Add(new BaseBuilderFFQueueManager(this, building, player, playerPower, playerResources, resourceLayer));
			foreach (var defense in Info.DefenseQueues)
				builders.Add(new BaseBuilderFFQueueManager(this, defense, player, playerPower, playerResources, resourceLayer));
		}
