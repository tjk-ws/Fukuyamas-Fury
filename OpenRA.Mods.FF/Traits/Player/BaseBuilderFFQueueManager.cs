...
{
	class BaseBuilderFFQueueManager
	{
		readonly string category;

		readonly BaseBuilderFFBotModule baseBuilder;
		...
		public BaseBuilderFFQueueManager(BaseBuilderFFBotModule baseBuilder, string category, Player p, PowerManager pm,
