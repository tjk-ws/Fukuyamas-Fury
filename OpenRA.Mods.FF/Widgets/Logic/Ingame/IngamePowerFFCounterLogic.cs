...
{
	public class IngamePowerFFCounterLogic : ChromeLogic
	{
		[ObjectCreator.UseCtor]
		public IngamePowerFFCounterLogic(Widget widget, World world)
		{
			...
			power.GetText = () => powerManager.PowerProvided == 1000000 ? "inf" : powerManager.PowerDrained.ToString() +
